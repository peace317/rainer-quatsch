            ...
            <div id="home" className="landing-wrapper overflow-hidden">
                <div className="py-4 px-4 mx-0 md:mx-6 lg:mx-8 lg:px-8 flex align-items-center justify-content-between relative lg:static">
                    <Link href="/" className="flex align-items-center">
                        ...
                        />
                        <span className="text-900 font-medium text-2xl line-height-3 mr-8">RainerQuatsch</span>
                    </Link>
                    <StyleClass
                ...
                >
                    <div className="mx-4 md:mx-8 mt-0 md:mt-4 mb-4">
                        <h1 className="text-6xl font-bold text-gray-900 line-height-2">
                            <span className="font-light block">RainerQuatsch.</span>Will mehr als nur spielen.
                        </h1>
                        <p className="font-normal text-2xl line-height-3 md:mt-3 text-gray-700 mb-0">
                            Zieht dir die Wurst vom Teller:
                        </p>
                        <p className="font-normal text-2xl line-height-3 text-gray-700 mt-0">
                            du willst Spaß haben, dann Ruf an 0900 - 1111{' '}
                        </p>
                        <Button
                            type="button"
                            label="Get Started"
                ...
                <div id="features" className="py-4 px-4 lg:px-8 mt-5 mx-0 lg:mx-8">
                    <div className="grid justify-content-center">
                        <div className="col-12 text-center mt-8 mb-4">
                            ...
                            <span className="text-600 text-2xl">Trusted by many companies who put relationships first.</span>
                        </div>
                            ...
                            >
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <span className="text-600">
                                        20+ minutes save on back-and-forth emails when scheduling new meetings
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
                            ...
                            >
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    >
                                        <i className="pi pi-fw pi-mobile text-2xl text-cyan-700"></i>
                                    </div>
                                    <h5 className="mb-2 text-900">Mobile</h5>
                                    <span className="text-600">First class support for responsive design led by touch optimized elements.</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg:pb-5 mt-4 lg:mt-0">
                            ...
                            >
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <span className="text-600">For vampires</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 mt-4 lg:mt-0">
                            ...
                            >
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <span className="text-600">Optimize your workflow and boost efficiency.</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 mt-4 lg:mt-0">
                            ...
                            >
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <span className="text-600">Combine personal with professional and use browser-based meetings to support.</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg-4 mt-4 lg:mt-0">
                            ...
                            >
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <span className="text-600">Any collection, processing and use of data is solely for the purpose of providing our services.</span>
                                </div>
                            </div>
                        </div>
                        ...
                        >
                            <div className="flex flex-column justify-content-center align-items-center text-center px-3 py-3 md:py-0">
                                ...
                                >
                                    “Immediate call directly on your website or a meeting scheduled for next week - with Vidas, you can provide your customers and teammates with both. One tool for all video communication needs.“
                                </p>
                ...
                <div id="highlights" className="py-4 px-4 lg:px-8 mx-0 my-6 lg:mx-8">
                    <div className="text-center">
                        ...
                        <span className="text-600 text-2xl">All that without any downloads, registrations, logins. Be accessible.</span>
                    </div>
                    ...
                    <div className="grid mt-8 pb-2 md:pb-8">
                        ...
                        <div className="col-12 lg:col-6 my-auto flex flex-column lg:align-items-end text-center lg:text-right">
                            ...
                            <h2 className="line-height-1 text-900 text-4xl font-normal">Browser based technology</h2>
                            <span className="text-700 text-2xl line-height-3 ml-0 md:ml-2" style={{ maxWidth: '650px' }}>
                                Interact with your clients on any device. No need for special installments or login requirements. Cross-platform compatibility laveraged by WebRTC.
                            </span>
                        </div>
                    </div>
                    ...
                    <div className="grid my-8 pt-2 md:pt-8">
                        <div className="col-12 lg:col-6 my-auto flex flex-column text-center lg:text-left lg:align-items-start">
                            ...
                            <h2 className="line-height-1 text-900 text-4xl font-normal">Powerful client management</h2>
                            <span className="text-700 text-2xl line-height-3 mr-0 md:mr-2" style={{ maxWidth: '650px' }}>
                                Insurance transactions often involve the quick inquiry of important documents and damage evidence.
                                Vidas allows agents to securely send and receive files in real-time during a conversation.
                                This reduces delays and eliminates the need for multiple follow-up emails or postal mail, thereby speeding up the decision-making process and improving overall efficiency.
                            </span>
                        </div>
                ...
                <div className="py-4 px-4 mx-0 mt-8 lg:mx-8">
                    <div className="grid justify-content-between">
                        <div className="col-12 md:col-2" style={{ marginTop: '-1.5rem' }}>
                            ...
                            >
                                <img
                                    src={`/layout/images/${layoutConfig.colorScheme === 'light' ? 'logo-dark' : 'logo-white'
                                        }.svg`}
                                    alt="footer sections"
                                    width="50"
                                    height="50"
                                    className="mr-2"
                                />
                                <span className="font-medium text-3xl text-900">RainerQuatsch</span>
                            </Link>
                        </div>
                        ...
                        <div className="col-12 md:col-10 lg:col-7">
                            <div className="grid text-center md:text-left">
                                <div className="col-12 md:col-3">
                                    ...
                                    <a href='https://msg-insurit.com/de/company-info-pointing-the-way/' className="line-height-3 text-xl block cursor-pointer mb-2 text-700">About Us</a>
                                    <a href='https://msg-insurit.com/de/newsroom/' className="line-height-3 text-xl block cursor-pointer mb-2 text-700">News</a>
                                    <a href='https://msg-insurit.com/de/produktuebersicht/' className="line-height-3 text-xl block cursor-pointer mb-2 text-700">
                                        Investor Relations
                                    </a>
                                    <a href='https://msg-insurit.com/de/karriere/stellenangebote/' className="line-height-3 text-xl block cursor-pointer mb-2 text-700">Careers</a>
                                    <a href='https://msg-insurit.com/de/media-center/' className="line-height-3 text-xl block cursor-pointer text-700">Media Kit</a>
                                </div>

                                <div className="col-12 md:col-3 mt-4 md:mt-0">
                                    <h4 className="font-medium text-2xl line-height-3 mb-3 text-900">Resources</h4>
                                    <a href='' className="line-height-3 text-xl block cursor-pointer mb-2 text-700">Get Started</a>
                                    <a href='' className="line-height-3 text-xl block cursor-pointer mb-2 text-700">Learn</a>
                                    <a href='' className="line-height-3 text-xl block cursor-pointer text-700">Case Studies</a>
                                </div>

                                <div className="col-12 md:col-3 mt-4 md:mt-0">
                                    <h4 className="font-medium text-2xl line-height-3 mb-3 text-900">Community</h4>
                                    <a href='https://www.instagram.com/msginsurit/' className="line-height-3 text-xl block cursor-pointer mb-2 text-700">Instagram</a>
                                    <a href='https://msg-insurit.com/de/events/' className="line-height-3 text-xl block cursor-pointer mb-2 text-700">
                                        Events
                                        <img src="/images/landing/new-badge.svg" className="ml-2" alt="badge" />
                                    </a>
                                    <a href='https://msg-insurit.com/de/kontakt/' className="line-height-3 text-xl block cursor-pointer mb-2 text-700">Contact</a>
                                    <a href='https://msg-insurit.com/de/blog-msg-insurit/' className="line-height-3 text-xl block cursor-pointer text-700">Blog</a>
                                </div>

                                <div className="col-12 md:col-3 mt-4 md:mt-0">
                                    <h4 className="font-medium text-2xl line-height-3 mb-3 text-900">Legal</h4>
                                    <a href='https://msg-insurit.com/de/company-info-pointing-the-way/' className="line-height-3 text-xl block cursor-pointer mb-2 text-700">Brand Policy</a>
                                    <a href='https://msg-insurit.com/de/datenschutz/' className="line-height-3 text-xl block cursor-pointer mb-2 text-700">
                                        Privacy Policy
                                    </a>
                                    <a href='https://msg-insurit.com/de/company-info-pointing-the-way/supplier-code-of-conduct/' className="line-height-3 text-xl block cursor-pointer text-700">Supplier Code of Conduct</a>
                                    <a href='https://msg-insurit.com/de/datenschutz/' className="line-height-3 text-xl block cursor-pointer text-700">Terms of Service</a>
                                </div>
                            </div>
                        </div>
                    </div>
